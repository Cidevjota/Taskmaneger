...
// O agendamento vive no pg_cron (migration `cron_process_routines`), e não aqui:
// `Deno.cron` não existe no Edge Runtime da Supabase e sua mera presença no módulo
// derrubava o boot — a function inteira respondia 500, então nem as rotinas nem o
// retry do WhatsApp chegavam a rodar. O cron do Postgres chama este endpoint via
// pg_net a cada 15 minutos.
